...
<head>
    ...
    <title>PaintSky Admin Template</title>
    <!-- Bootstrap Core CSS -->
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li>
                        <a class="profile-pic" href="#">
                         <img src="../plugins/images/users/admin-logo.png" alt="user-img" width="36" class="img-circle">
                         <b class="hidden-xs">Admin</b></a>
                    </li>
                    <li>
                        <a class="profile-pic" href="../../logout.php">
                         <img src="../plugins/images/users/logout.jpg" alt="log-out" width="36" class="img-circle mt-5">
                      </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">
                            <a href="student_add.php">Add Students</a></h3>
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">
                            <a href="student_update.php">Update Students</a></h3>
                     </div>
                     </div>
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">
                            <a href="student_delete.php">Delete Students</a></h3>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="white-box">
                            <h3 class="box-title">Students Yearly Graphs</h3>
                            <ul class="list-inline text-right">
                                <li>
                                    <h5><i class="fa fa-circle m-r-5 text-info"></i>Students</h5> </li>
                                <li>
                                    <h5><i class="fa fa-circle m-r-5 text-inverse"></i>Standards</h5> </li>
                            </ul>
